...
function AnnouncementModal({ isOpen, onClose, onSave, announcement = null }) {
  ...
  return (
    <BaseModal isOpen={isOpen} onClose={handleCancel} className="announcement-modal" maxWidth="600px">
      <ModalHeader
        title={title}
        subtitle={announcement ? 'Update announcement details' : 'Create a new announcement to display to users'}
