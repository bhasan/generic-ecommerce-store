...
import { createAnnouncementValidators, updateAnnouncementValidators } from '../validators/announcement.validator';
...
router.post('/', authenticate, authorizeAdmin, createAnnouncementValidators, asyncHandler(announcementController.createAnnouncement));
router.patch('/:id', authenticate, authorizeAdmin, requireIntParam('id', 'announcement'), updateAnnouncementValidators, asyncHandler(announcementController.updateAnnouncement));
